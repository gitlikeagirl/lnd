...
type Resolution_ResolutionType int32

const (
	Resolution_UNKNOWN Resolution_ResolutionType = 0
	// We swept our anchor output.
	Resolution_ANCHOR_RECOVERED Resolution_ResolutionType = 1
	// Somebody else swept our anchor output.
	Resolution_ANCHOR_LOST Resolution_ResolutionType = 2
	// We gave up on sweeping our anchor output.
	Resolution_ANCHOR_UNCLAIMED Resolution_ResolutionType = 3
	// We timed out one of our outgoing htlcs.
	Resolution_OUTGOING_TIMEOUT Resolution_ResolutionType = 4
	// The remote party claimed one of our outgoing htlcs using the
	// preimage.
	Resolution_OUTGOING_CLAIM Resolution_ResolutionType = 5
	// We claimed an incoming htlc using the preimage.
	Resolution_INCOMING_CLAIM Resolution_ResolutionType = 6
	// An incoming htlc timed out on chain, so we stopped waiting for the
	// preimage to be revealed.
	Resolution_INCOMING_TIMEOUT Resolution_ResolutionType = 7
	// Our peer tried to resolve one of our incoming htlcs on chain but we
	// failed it.
	Resolution_INCOMING_FAILED Resolution_ResolutionType = 8
	// We swept our time locked commitment output on chain.
	Resolution_COMMIT_SWEEP Resolution_ResolutionType = 9
	// We broadcast the first stage of a two stage htlc claim for an
	// incoming htlc on our commitment.
	Resolution_SUCCESS_TX Resolution_ResolutionType = 10
	// We broadcast the first stage of a two stage htlc timeout for an
	// outgoing htlc on our commitment.
	Resolution_TIMEOUT_TX Resolution_ResolutionType = 11
	// We previously locked in an invalid htlc that we now cannot resolve,
	// so we take no action.
	Resolution_INVALID_HTLC Resolution_ResolutionType = 12
)

var Resolution_ResolutionType_name = map[int32]string{
	0:  "UNKNOWN",
	1:  "ANCHOR_RECOVERED",
	2:  "ANCHOR_LOST",
	3:  "ANCHOR_UNCLAIMED",
...
var Resolution_ResolutionType_value = map[string]int32{
	"UNKNOWN":          0,
	"ANCHOR_RECOVERED": 1,
	"ANCHOR_LOST":      2,
	"ANCHOR_UNCLAIMED": 3,
...
func (x Resolution_ResolutionType) String() string {
	return proto.EnumName(Resolution_ResolutionType_name, int32(x))
}

func (Resolution_ResolutionType) EnumDescriptor() ([]byte, []int) {
...
func (PendingChannelsResponse_ForceClosedChannel_AnchorState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 5, 0}
}
...
type Resolution struct {
	// The outcome of our the on chain action that resolved the outpoint.
	Type Resolution_ResolutionType `protobuf:"varint,1,opt,name=type,proto3,enum=lnrpc.Resolution_ResolutionType" json:"type,omitempty"`
	...
	// output.
	SweepTxid            string   `protobuf:"bytes,4,opt,name=sweep_txid,json=sweepTxid,proto3" json:"sweep_txid,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Resolution) GetType() Resolution_ResolutionType {
	if m != nil {
		return m.Type
	}
...
func (*PendingChannelsResponse_PendingChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 0}
}
...
func (*PendingChannelsResponse_PendingOpenChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 1}
}
...
func (*PendingChannelsResponse_WaitingCloseChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 2}
}
...
func (*PendingChannelsResponse_Commitments) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 3}
}
...
func (*PendingChannelsResponse_ClosedChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 4}
}
...
func (*PendingChannelsResponse_ForceClosedChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{69, 5}
}
...
func init() {
	...
	proto.RegisterEnum("lnrpc.Resolution_ResolutionType", Resolution_ResolutionType_name, Resolution_ResolutionType_value)
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	// 11909 bytes of a gzipped FileDescriptorProto
	,
}
