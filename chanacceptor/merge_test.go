...
func TestMergeResponse(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			err: mergeError(fieldUpfrontShutdown, addr1, addr2),
		},
		{
			name: "different csv",
			current: ChannelAcceptResponse{
		...
		},
		{
			...
			err: mergeError(fieldReserve, 1, 2),
		},
		{
		...
		},
		{
			...
			err: mergeError(fieldHtlcLimit, 1, 2),
		},
		{
		...
		},
		{
			...
			err: mergeError(fieldMinDep, 1, 2),
		},
		{
