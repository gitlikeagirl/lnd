...
// invoiceExpiry is a vanity interface for different invoice expiry types which
// implement the priority queue item interface, used to improve code
// readability.
type invoiceExpiry queue.PriorityQueueItem

// Compile time assertion that invoiceExpiryTs implements invoiceExpiry.
var _ invoiceExpiry = invoiceExpiryTs{}
