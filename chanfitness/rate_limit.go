...
var (
	...
	// rateLimits is the set of rate limit tiers we apply to our peers
	// based on their flap count. A peer can be placed in their tier by
	// dividing their flap count by the rateLimitScale and returning the
	// value at that index.
