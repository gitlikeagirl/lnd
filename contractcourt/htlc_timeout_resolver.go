...
func (h *htlcTimeoutResolver) claimCleanUp(
	...
	return nil, h.Checkpoint(h, h.putResolverReport(
		channeldb.ResolverOutcomeOutgoingHtlcClaim,
...
func (h *htlcTimeoutResolver) Resolve() (ContractResolver, error) {
	...
	h.resolved = true
	return nil, h.Checkpoint(h, h.putResolverReport(
		channeldb.ResolverOutcomeOutgoingHtlcTimeout, spendTxID,
	))
}
...
func (h *htlcTimeoutResolver) putResolverReport(outcome channeldb.ResolverOutcome,
	spendTx *chainhash.Hash) func(tx kvdb.RwTx) error {

	amt := btcutil.Amount(h.htlcResolution.SweepSignDesc.Output.Value)

	return func(tx kvdb.RwTx) error {
		return h.PutResolverReport(
			tx, &channeldb.ResolverReport{
